...
class PomfTVLiveIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return {
            ...
            'formats': [{'url': f'https://{subdomain}.pomf.tv/srs/live/{vhash}.flv',
                         'format_id': 'flv', 'height': 1080, 'width': 1920},
                        {'url': f'https://{subdomain}.pomf.tv/hls-live/{vhash}_hd720/index.m3u8',
